...
<title>MyCartPharmacy</title>
    ...
    <?php
        ...
        if (isset($_POST["btn_checkout"])) {
                ...
                $upQry1 = "update tbl_booking set booking_date=curdate(),booking_amount='".$amt."',booking_status='1' where user_id='" .$_SESSION["uid"]. "' and booking_id=".$row["booking_id"];
				$Con->query($upQry1);
